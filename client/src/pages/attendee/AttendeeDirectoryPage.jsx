...
import DirectoryTable from '../exhibitor/DirectoryTable';
...
const AttendeeDirectoryPage = () => {
  ...
  const handleSendInquirySubmit = async (e) => {
    ...
    if (!recipientId) {
      toast.error('Cannot message this exhibitor: direct contact not found');
      return;
    }
    ...
    <div className="space-y-6 max-w-6xl">
      <div className="page-header-accent">
        ...
        <p style={{ color: 'var(--color-text-muted)' }} className="text-xs mt-0.5">
          Connect and collaborate with participating vendors and event partners
        </p>
      </div>
